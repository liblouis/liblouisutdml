...
{				/*user data */
  ...
  int footer_length;
  char *contracted_table_name;
  char *uncontracted_table_name;
  char *compbrl_table_name;
  char *mathtext_table_name;
  char *mathexpr_table_name;
  char *edit_table_name;
  char *semantic_files;
  char *volume_sem;
