...
"HEADERS = $(SRCDIR)\louis.h include\liblouisutdml.h include\config.h",
"LINK = link.exe",
"DLLFLAGS = /dll /nologo /DEF:liblouisutdml.def /OUT:liblouisutdml.dll",
"LIB = lib.exe",
"LIBFLAGS = /nologo",
"OBJ = ",
"!if \"$(UCS)\" == \"2\"",
...
"    $(LINK)  $(DLLFLAGS) $(OBJ)  /libpath:$(LIBPATH)",
